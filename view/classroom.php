    ...
    <div id="page-content-wrapper" class="w-100">
        <section class="container-fluid text-center"> 
            ...
            <div class="col col-md-2 my-2">
                    <a class="btn btn-outline-success btn-block" href="../view/edit_classroom.php?id=<?php echo $_GET['clid'] ?>" role="button">Editar</a>
                </div>
                <div class="col col-md-2 my-2">
                    <a id="btndelete" class="btn btn-outline-danger btn-block" href="../controller/CandidateController.php?id=<?php echo $_GET['clid'] ?>&delete=1"  data-href="../controller/ClassroomController.php?id=<?php echo $_GET['clid'] ?>&delete=1" data-toggle="modal" data-target="#confirm-delete" onclick="modalHref(this)" role="button">Apagar</a>
                </div>
            </div>    
