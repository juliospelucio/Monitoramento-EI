	                    ...
	                    <div class="col-md-6 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
							  	<div class="input-group-prepend">
							  		<span class="input-group-text" id="basic-addon-desc">Descrição</span>
								</div>
								<input type="text" required class="form-control" id="desc" name="desc" aria-describedby="basic-addon-desc">
